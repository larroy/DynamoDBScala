...
case class Table(
  ...
  def get(hashPK: Any)(implicit dynamoDB: DynamoDB) = getItem(hashPK)
  def get(hashPK: Any, rangePK: Any)(implicit dynamoDB: DynamoDB) = getItem(hashPK, rangePK)

  def getItem(hashPK: Any)(implicit dynamoDB: DynamoDB) =
